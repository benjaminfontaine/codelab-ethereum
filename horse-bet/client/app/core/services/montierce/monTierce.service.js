...
export class MonTierceService {
  ...
  parier(idCourse, tierce, mise){
    //appel de la fonctionnalité de pari avec comme paramètres l'id course, le tierce, et la mise du pari 
    //(champs value de l'objet en dernier paramètre de l'appel)
    //la value est exprimée en wei.
    //pour convertir des ethers en wei : window.web3.toWei(ethervalue, 'ether')
    return FIX_ME;
  }
